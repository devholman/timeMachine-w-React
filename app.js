    ...
    var AppView = _react2.default.createClass({
        ...
        render: function render() {
            return _react2.default.createElement(
                "div",
                { className: "container" },
                _react2.default.createElement(TimeMachine, null)
            );
        }
    });

    var TimeMachine = _react2.default.createClass({
        ...
        _increaseYear: function _increaseYear() {
            if (!this.state.changeTime) {
                var increaseFunc = function increaseFunc() {
                    this.setState({
        ...
        _decreaseYear: function _decreaseYear() {
            if (!this.state.changeTime) {
                var decreaseFunc = function decreaseFunc() {
                    this.setState({
                        year: this.state.year - 1,
                        changeTime: true
                    });
